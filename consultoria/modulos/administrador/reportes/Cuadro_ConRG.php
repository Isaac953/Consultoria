...
$id=$_SESSION['id_usuario'];
 ...
 //$query="select * from Consultoria";
 $query="select distinct(c.Codigoconsultoria), P.Nombres, c.NombreConsultoria, c.FechaInicio,
 c.FechaFinal, c.FechaRegistro, c.Presupuesto, c.FormaPa, c.TDR, c.TipoConsultoria, 
 c.NivelAlcance from Consultoria C, Asignacion A, Personal P, ofertas f, EvaluacionOfertas e where C.Codigoconsultoria=A.CodigoConsultoria and 
A.CodigoPersonal=P.CodigoPersonal
and c.Codigoconsultoria=f.Codigoconsultoria and
e.CodigoOferta= f.CodigoOferta ";     
...
<legend><h3 align=center><p style="font-family: Verdana; color:#0072bb"><strong>REPORTE DE OFERTAS GENERAL</strong></p></h3></legend>
