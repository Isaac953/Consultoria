<?php 
 ...
 //$query="select * from Criterios C, ParametrosCriterios P where C.CodigoCriterio=P.CodigoCriterio;";
 $query="select C.Criterio, P.Parametro, P.Ponderacion as pondeP, C.Ponderacion as pondeC,  P.CodigoParametrosCriterios from Criterios C, ParametrosCriterios P where C.CodigoCriterio=P.CodigoCriterio;";
...
<head>
  <meta charset="UTF-8">
  <title>Mantenimientos de Parametros</title>
...
<legend><h3 align=center><p style="font-family: Verdana; color:#0072bb"><strong>MANTENIMIENTO DE PARÁMETROS DE EVALUACIÓN</strong></p></h3></legend>

        <div><button class="myButton" id="myButton" style="box-shadow: 0px 1px 0px 0px rgb(151, 196, 254) inset; background: rgb(61, 148, 246) linear-gradient(to bottom, rgb(61, 148, 246) 5%, rgb(30, 98, 208) 100%) repeat scroll 0% 0%; border-radius: 6px; border: 1px solid rgb(51, 127, 237); display: inline-block; cursor: pointer; color: rgb(255, 255, 255); font-family: Arial; font-size: 15px; font-weight: bold; padding: 6px 24px; text-decoration: none; text-shadow: 0px 1px 0px rgb(21, 112, 205);" onclick="showNewParametros()" >Nuevo Parámetro</button></div>
        <br>
                <thead>
                    <tr width=90px, height=35px>
            <th style='text-align:center;' width="10%">Id</th>
            <th style='text-align:center;' width="20%">Criterio</th><!--Estado-->
            <th style='text-align:center;' width="20%">Parámetro</th>
            <th style='text-align:center;' width="20%">Ponderación</th>
