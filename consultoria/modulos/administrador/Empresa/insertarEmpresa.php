...
$lsMunicc=$_POST["lsMunic"];

/*
echo "Pais empresa: ".$lsPais;
echo "<br>";
echo "Municipio empresa: ".$lsMunic;
echo "paises municipios:<br>";

print_r($lsPaisConsult);


echo "municipios consultores: <br>";
print_r($lsMunicc);
...
header("Location:Empresa_Consultores.php");	
