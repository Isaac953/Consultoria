...
$query="
select c.Codigoconsultoria, c.NombreConsultoria, c.CodigoPersonal, c.FechaInicio, c.FechaFinal, c.FechaRegistro, c.Presupuesto, c.FormaPa, c.TipoConsultoria, c.TDR, c.NivelAlcance from Consultoria c left join Asignacion a
on c.Codigoconsultoria=a.CodigoConsultoria
 where c.Codigoconsultoria not in(select a.CodigoConsultoria from asignacion a join Consultoria c on a.CodigoConsultoria=c.Codigoconsultoria)
";
