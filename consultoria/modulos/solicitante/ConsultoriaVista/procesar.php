...
if(isset($_POST["idArea11"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea11"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea22"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea22"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea33"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea33"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea44"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea44"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea55"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea55"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea66"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea66"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea77"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea77"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea88"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea88"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea99"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea99"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
...
if(isset($_POST["idArea101"]))
{
		$opciones = '<option value="0"> Elija una Sub Area</option>';
		$strConsulta = "select * from AreaEspecializacion A, SubArea S where A.CodigoArea=S.CodigoArea and A.CodigoArea=".$_POST["idArea101"];
		$consulta = sqlsrv_query($conexion, $strConsulta);
	   while ($fila=sqlsrv_fetch_object($consulta))
  {
  $opciones.='<option value="'.$fila->CodigoSubArea.'">'.$fila->SubArea.'</option>';
