...
if(isset($_POST["idDepartamento111"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento111"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento222"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento222"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento333"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento333"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento444"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento444"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento555"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento555"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento666"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento666"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento777"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento777"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento888"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento888"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento999"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento999"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
			...
			if(isset($_POST["idDepartamento1010"]))
			{
			//$strConsulta = "select id, modelo from modelo where idmarca ="."'".$cod."'";
			$opciones = '<option value="0"> Elija un Municipio</option>';	
			$strConsulta = "select * from Municipios M, Departamentos D where  M.CodigoDepartamento=D.CodigoDepartamento and D.CodigoDepartamento=".$_POST["idDepartamento1010"];
			$consulta = sqlsrv_query($conexion, $strConsulta);
			while ($fila=sqlsrv_fetch_object($consulta))
			{
			$opciones.='<option value="'.$fila->CodigoMunicipio.'">'.$fila->NombreMunicipio.'</option>';
