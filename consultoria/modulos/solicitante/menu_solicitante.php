...
<li class="subitem1"><a href="#" class="list-group-item" onclick="ShowConsultores();"><i class="fa fa-user-plus"><span style="font-family: Arial;"> Evaluar Consultores </i></span></a></li>             
