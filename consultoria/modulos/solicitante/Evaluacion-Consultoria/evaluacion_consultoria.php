...
$consulta="select * from Criterios C where  C.TipoCriterio='Evaluacion de Consultoria' and EstadoC = 1";
$resultado=sqlsrv_query($conexion,$consulta);

$idcontrato=$_POST["valorCaja1"];
$idpersonal=$_POST["valorCaja2"];

//echo $id2;

//echo 'Id Personal: '.$idpersonal;
//echo '<br>Id Contrato'.$idcontrato;
...
<br>
        <!--TABLA DE CRITERIOS-->
<input type="hidden" name="txtIdContrato" value="<?php echo $idcontrato; ?>" />
<input type="hidden" name="txtIdUsuario"  value="<?php echo $idpersonal; ?>" />
