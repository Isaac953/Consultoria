...
$query="SELECT o.CodigoOferta,  
o.NombreEmpresa, o.Nit,o.Telefono, a.CodigoAsignacion,c.NombreConsultoria, c.TipoConsultoria
 FROM Consultoria c 
JOIN Asignacion a ON c.CodigoConsultoria = a.CodigoConsultoria
JOIN Ofertas o on c.Codigoconsultoria = o.Codigoconsultoria
where a.CodigoPersonal = '$idus' 
and o.CodigoOferta not in (SELECT distinct e.CodigoOferta 
FROM evaluacionOfertas e join Asignacion a on e.CodigoAsignacion = a.CodigoAsignacion where a.CodigoPersonal = '$idus');";
...
<div STYLE=" width: 100%; font-size: 12px; overflow: auto;">
            ...
            <legend><h3 align=center><p style="font-family: Verdana; color:#0E5DFD"><strong>LISTADO DE OFERTAS A EVALUAR</strong></p></h3></legend>
