...
<legend><h3 align=center><p style="font-family: Verdana; color:#0072bb"><strong>REPORTE DE OFERTAS EVALUADAS</strong></p></h3></legend>
        ...
        <tbody>
          ...
          $presu=number_format($row['Presupuesto']); ?>
            <tr width=90px, height=35px>
              ...
              <td  style='text-align:center;'><?php echo DATE_FORMAT($row['FechaFinal'], 'Y-m-d');?></td>
              <td style='text-align:center;'><?php echo DATE_FORMAT($row['FechaRegistro'], 'Y-m-d');?></td>
              <td style='text-align:center;'><?php echo "$".$presu;?></td>
