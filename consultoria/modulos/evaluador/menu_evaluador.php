...
<ul class="nav nav-pills nav-stacked">
    ...
    <ul class="menu2">
        <li class="item1"><a href="#" class="list-group-item"><i class="fa fa-user"><span style="font-family: Arial; font-weight: bold;"> Evaluaciones </i></span></a>
            <ul>
                <li class="subitem1"><a href="#" class="list-group-item" onclick="showEvaluacion();"><i class="fa fa-user-plus"><span style="font-family: Arial;"> Evaluación de Ofertas</i></span></a></li>
                <li class="subitem1"><a href="#" class="list-group-item" onclick="showHistorial4();"><i class="fa fa-user-plus"><span style="font-family: Arial;"> Historial de Evaluaciones</i></span></a></li>
            </ul>
        </li>
